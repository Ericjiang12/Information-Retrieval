...
from datamodel.search.Yifanj6Yzeng5_datamodel import Yifanj6Yzeng5ProjectionLink
...
@Deleter(Yifanj6Yzeng5ProjectionLink)
@Getter(Yifanj6Yzeng5ProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(Yifanj6Yzeng5ProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(Yifanj6Yzeng5ProjectionLink, l)
